...
*2. Öffentlicher Schlüssel in GitHub registireren.:*
*3. GitHub URL auf ssh umstellen:*
...
### Switch the URLs from HTTPS to SSH
cd ~/org/live-scripting
git remote -v
#origin  https://github.com/andreaswittmann/live-scripting.git (fetch)
#origin  https://github.com/andreaswittmann/live-scripting.git (push)
git remote set-url origin  https://github.com/andreaswittmann/live-scripting.git
git remote set-url origin  ssh://git@github.com/andreaswittmann/live-scripting.git
