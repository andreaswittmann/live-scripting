...
#+begin_src bash
### Clean up 
sudo rm -rf   /var/www/html/live-scripting
### create directoy for project live-scripting
sudo mkdir -p   /var/www/html/live-scripting
### nginx worker and lubuntu must  have access
sudo chown lubuntu  /var/www/html/live-scripting

cd  /var/www/html/live-scripting
ls -la

### Force regenerating the project
rm -r  /var/www/html/live-scripting/*
ls -la  /var/www/html/live-scripting
find  /var/www/html/live-scripting
...
** Integration of a org-html-themes fork 
I have used the GitHub project org-html-themes for applying style sheets to my local website. Now I want to fork this project. I can than make local modifications to the themes. I also want to integrate it into my local website.
...
Now, I make a local clone of the project.
